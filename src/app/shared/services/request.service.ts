...
export class RequestService {
  ...
  bulidingDataWithIds() {
    this.bulidingFloorData = [
      ...
      // start MA.III 0 section
      {
        buildingId: "20",
            planType: "MA.III 0",
            zoneList: [
              {
                floorName: '30.GF.CorridorN',
                zoneSubList: [
                    {
                    value: '30.GF-S.300',
      ...
      // end MA.III 0 section

      // start MA.III 1 section
      ...
      // end MA.III 2 section

      // start MA.III 2 section
